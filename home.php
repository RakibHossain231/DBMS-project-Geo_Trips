...
$query = "SELECT package.id, package.descriptions, package.price, package.trip_duration,
...
<body class="bg-blue-100">
            ...
            <div id="slide1" class="carousel-item relative w-full bg-gradient-to-r from-blue-200 to-blue-400  bg-opacity-55 gap-y-8">
                ...
                <div class="flex flex-col md:flex-row justify-between">
                    ...
                    <div class="flex flex-col  items-start justify-center gap-y-10 p-10 flex-1 text-black">
                        ...
                        <a href="package_card.php"><button class="btn bg-blue-500 hover:bg-teal-300 p-4">Explore</button></a>
                    </div>
                    <!-- image content  -->
    ...
    <section class="mx-10 mt-2 p-10 grid grid-cols-2 items-center justify-between gap-10  bg-[url('resources/images/hero_bg.jpg')] rounded-lg ">
        ...
        <div
            ...
            <div class="flex flex-row gap-3">
                ...
                <a href="package_card.php"><button class="btn p-4 bg-red-500 hover:bg-red-600 border-none"><i class="fa-solid fa-camera"
                        style="color: #B197FC;"></i>Start your Journey</button></a>
                <!-- Leads to a list of travel locations -->
                <a href="visa_docs.php"><button class="btn p4 bg-green-300 p-4 hover:bg-green-200 "><i class="fa-solid fa-passport text-lg" style="color: #74C0FC;"></i>Visa Assistance</button></a>
            </div>
        </div>
        <div>
    ...
    <section class="container  mt-2 p-10" >
        ...
        <?php foreach ($packages as $row): 
            ...
            $trip_duration = htmlspecialchars($row['trip_duration']);
        ...
        ?>
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col h-full">
                ...
                <div class="p-6 flex-grow">
                    ...
                    <p class="text-sm text-gray-600 mb-1"><strong>Trip Duration:</strong> <?= $trip_duration ?> days</p>
