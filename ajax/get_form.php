...
<form method="POST" action="ajax/save_package.php" class="grid grid-cols-2 gap-4 mt-4">
  ...
  <div class="mb-4">
    <label for="trip_duration" class="block text-sm font-medium text-gray-700">Trip Duration (in days)</label>
    <input type="number" name="trip_duration" id="trip_duration" placeholder="e.g., 4" class="border p-2 rounded w-full" required>
  </div>
