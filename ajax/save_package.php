...
$insertPackage = "INSERT INTO package (price, duration, trip_duration, descriptions, availability, commission_rate, image_url, location_id, start_date)
                  VALUES ('$price', '$duration', '$trip_duration', '$descriptions', '$availability', '$commission_rate', '$image_url', '$location_id', '$start_date')";
